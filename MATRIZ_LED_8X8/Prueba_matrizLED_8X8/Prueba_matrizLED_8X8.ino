...
void loop() {
  // Animación de barrido desde la el primer led haste el último iluminando todo
...
// Animación que hace lo contrario a la anumación anterior
...
// Patrones predeterninados
  matriz.ENCENDER_TODOS(); delay(1000); // Para encender todos los leds de la matriz
  matriz.APAGAR_TODOS(); delay(500); // Para apagar todos los leds
